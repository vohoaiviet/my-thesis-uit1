...
Chi tiết các thành phần được trình bày trong các phần tiếp theo (\ref{subsubsection:server_side}, \ref{subsection:web_service} \ref{subsection:client_side}).
...
\begin{figure}[!htbp]
  \begin{center}
    \leavevmode
    \ifpdf
      \includegraphics[scale=0.36]{interface_4}
    \else
      \includegraphics[scale=0.36]{interface_4}
    \fi
